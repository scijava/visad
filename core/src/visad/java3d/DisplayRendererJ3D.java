...
import org.scijava.java3d.GraphicsContext3D;
...
*/
    ...
    // WLH 23 Oct 2001
    try {
      Class modelClipClass = Class.forName("org.scijava.java3d.ModelClip");
      ...
      param = new Class[] {int.class, org.scijava.vecmath.Vector4d.class};
      modelClipSetPlane = modelClipClass.getMethod("setPlane", param);
      param = new Class[] {org.scijava.java3d.Group.class};
      ...
      param = new Class[] {org.scijava.java3d.Bounds.class};
